...
public class Character2 : CharacterModel {
	...
	public Character2() {
		...
		messages = new Message[] {
			...
			new Message(15, "I need to get the hell out of here. The cabin... It looks like it’s going to rip off from the rest of the ship... I can try to find you, or fix the motor... What do you think? What should I do? Just can’t think straight locked away like this!!", new Response[] { new Response("", false, 16)}),
