...
public class Character1 : CharacterModel {
	...
	public Character1() {
		...
		messages = new Message[] {
			...
			new Message(4, "What happened? That explosion was bizarre! I am a lot more calm now that I know our ship is fine. I have been worried that the worst had happened. I am in a strange planet, full of water and nature... Where am I?", new Response[] { new Response("Earth", true, 5)}),
			new Message(5, "I am on Earth? How did we get here? I believe this planet still have a lot of living creatures on it... I can see some destroyed structures from where I am. It is funny to see Feline Buildings. \n My locator is giving me strange values \n X= \n Y= \n Can you help me find out where I am?", new Response[] { new Response("", true, 6)}),
			new Message(6, "Hey, hey, I think I found some habitants, they look like they are hurt. I have talked to them and they said that there’s a lost Feline Ship and they are looking for a way out of here. I could take a look with them, do you think I should go?", new Response[] { new Response("Yes", false, 7), new Response("No", false, 16)}),
			...
			new Message(8, "Remember when we were attacked by Space Pirates and almost lost our Ship?? If it wasn’t for my abilities, we would be doomed by now. You guys almost lost it. Clark even changed colors! Anyway, I need those coordenates, can you still get the for me?", new Response[] { new Response("", false, 9)}),
			...
			new Message(10, "Hey, Hey! Are you there? We found the spaceship! But I don’t have much time!! The floor is breaking and it won’t stand. I need some urgente information.", new Response[] { new Response("", true, 99)}),
