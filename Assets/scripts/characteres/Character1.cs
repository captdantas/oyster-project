...
public class Character1 : CharacterModel {
	...
	public Character1() {
		...
		messages = new Message[] {
			...
			new Message(5, "I am on Earth? How did we get here? I believe this planet still have a lot of living creatures on it... I can see some destroyed structures from where I am. It is funny to see Feline Buildings. \n My locator is giving me strange values \n X= -21.805149 \n Y=-49.089977 \n. This is such a strange location, and there is a city nearby, I need to know it's name. Could you tell me?", new Response[] { new Response("Bauru", true, 6), new Response("",true , 40)}),
			new Message(40,"Are you sure?? I don't think so...", new Response[] {new Response("",true, 5)}),
			...
			new Message(10, "Hey, Hey! Are you there? We found the spaceship! But I don’t have much time!! The floor is breaking and it won’t stand. I need some urgent information, I can't remember the name of that energy stone Clark used that time... It's the same we need right now.", new Response[] { new Response("Jade", true, 99), new Response("", true, 98)}),
