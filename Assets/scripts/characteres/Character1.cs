...
public class Character1 : CharacterModel {
	...
	public Character1() {
		...
		messages = new Message[] {
			...
			new Message(10, "Hey, Hey! Are you there? We found the spaceship! But I don’t have much time!! The floor is breaking and it won’t stand. I need some urgente information.", new Response[] { new Response("", false, 99)}),
